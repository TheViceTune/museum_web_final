export const storyCards = [
  {
    ...
    fullStory: `
      ...
      <img src="/museum_photos/stories/Bài 1/T1 - B1 - A1.png" alt="Vũ Xuân Thiều và chiếc MiG-21Lá thư của phi công Vũ Xuân Thiều gửi song thân (Ảnh: Báo Quân đội Nhân dân)" />
      <figcaption>Lá thư của phi công Vũ Xuân Thiều gửi song thân (Ảnh: Báo Quân đội Nhân dân)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 1/T1 - B1 - A2.png" alt="Vũ Xuân Thiều" />
      <figcaption>Phi công Vũ Xuân Thiều (Ảnh: Báo Quân đội Nhân dân)</figcaption>
      </div>
  ...
  },
  {
    ...
    fullStory: `
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 2/T1 - B2 - A1.png" alt="" />
      <figcaption>Chân dung phi công Nguyễn Văn Bảy thời trẻ (Ảnh: Báo Dân Việt)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 2/T1 - B2 - A2.png" alt="" />
      <figcaption>Giây phút “Chiến thắng trở về” của phi công Nguyễn Văn Bảy (Ảnh: Báo Vĩnh Long)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 2/T1 - B2 - A3.png" alt="" />
      <figcaption>Người phi công ấy luôn giữ lối sống chân chất, giản dị (Ảnh: Báo Lao Động)</figcaption>
      </div>
  ...
  },
  {
    ...
    fullStory: `
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 3/T1 - B3 - A1.png" alt="" />
      <figcaption>Chân dung Trung tướng phi công MiG-21 (Ảnh: Báo Dân Trí)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 3/T1 - B3 - A2.png" alt="" />
      <figcaption>Năm 25 tuổi, Nguyễn Văn Cốc trở thành phi công Việt Nam bắn hạ nhiều máy bay nhất, với 9 chiếc (Ảnh: Báo Dân Trí)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 3/T1 - B3 - A3.png" alt="" />
      <figcaption>Bác Hồ khen thưởng phi công Nguyễn Văn Cốc tại Đại hội Anh hùng-chiến sĩ thi đua Quân chủng Phòng không-Không quân năm 1969 </figcaption>
      </div>
  ...
  },
  {
    ...
    fullStory: `
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 4/T1 - B4 - A1.png" alt="" />
      <figcaption>Trung đoàn Không quân 921 - Anh cả “Đỏ” của Không quân (Ảnh: Báo Quân đội Nhân dân)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 4/T1 - B4 - A2.png" alt="" />
      <figcaption>Thiếu tướng, Anh hùng Lực lượng vũ trang Nhân dân Nguyễn Hồng Nhị (Ảnh: VTC News)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 4/T1 - B4 - A3.png" alt="" />
      <figcaption>Các phi công Trung đoàn 921 trao đổi kinh nghiệm sau ban bay huấn luyện (Ảnh: Báo Phòng không - Không quân)</figcaption>
      </div>
  ...
  },
  {
    ...
    fullStory: `
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 5/B5 - A1.png" alt="" />
      <figcaption>Pháo đài bay B-52 trong trận mưa bom Giáng sinh 1972 (Ảnh: Báo Bắc Ninh)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 5/B5 - A2.png" alt="" />
      <figcaption>Cuốn “Cẩm nang bìa đỏ” - tài liệu “gối đầu giường” của nhiều đơn vị phòng không lúc bấy giờ (Ảnh: Báo Quân đội nhân dân)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 5/B5 - A3.png" alt="" />
      <figcaption>Đài radar K8-60 trưng bày tại Bảo tàng Phòng không - Không quân (Ảnh: Báo Quân đội nhân dân)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 5/B5 - A4.png" alt="" />
  ...
  },
  {
    ...
    fullStory: `
      ...
      <figcaption>Máy bay F-111 Aardvark của Không quân Hoa Kỳ (Ảnh: Báo Công lý)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 6/B6 - A2.png" alt="" />
      <figcaption>Bà Phạm Thị Viễn, một trong những pháo thủ hạ gục máy bay F-111 vào đêm 22/12/1972 (Ảnh: Báo điện tử Dân Trí)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 6/B6 - A3.png" alt="" />
  ...
  },
  {
    ...
    fullStory: `
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 7/B7 - A1.png" alt="" />
      <figcaption>Phi đội bay trước trận đánh sử dụng máy bay MIG-21 số hiệu 5121 bắn rơi B-52 đêm 27/12/1972 (Ảnh: Báo VnExpress)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 7/B7 - A2.png" alt="" />
      <figcaption>Các phi công MiG-21 trao đổi kinh nghiệm tác chiến với đồng đội (Ảnh: Báo Gia Lai)</figcaption>
      </div>
      ...
      <div class="story-image-wrapper">
      <img src="/museum_photos/stories/Bài 7/B7 - A3.png" alt="" />
      <figcaption>Xác một chiếc B52 bị hạ gục trên bầu trời Hà Nội (Ảnh: Báo Quân đội nhân dân)</figcaption>
      </div>
