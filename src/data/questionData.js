export const puzzleQuestions = {
  ...
  "2-3": {
    ...
    options: ["900 km/h", "1.000 km/h", "1.300 km/h", "1.500 km/h"],
    correct: 2,
    explain:
  ...
  "3-2": {
    ...
    options: [
      "Dùng radar dự phòng mạnh hơn",
      "Bay lên cao để thoát nhiễu",
      "Quan sát bằng mắt thường và kính ngắm quang học",
      "Chờ dẫn đường từ mặt đất bằng pháo hiệu",
    ],
    correct: 2,
    explain:
  ...
  "4-1": {
    ...
    options: [
      "Nối dài thân đạn để tăng tầm bắn",
      "Gắn thêm động cơ phụ cho đạn",
      "Thay đổi tần số điều khiển rãnh đạn nhiều lần",
      "Chuyển sang dùng đầu đạn tự dẫn hồng ngoại",
    ],
    correct: 2,
    explain:
  ...
  "4-3": {
    ...
    options: [
      "Bắn đón đầu với số lượng pháo áp đảo",
      "Dùng đạn ngòi nổ hẹn giờ và cảm biến tiệm cận, cho đạn nổ ở nhiều độ cao khác nhau làm rối loạn đội hình địch",
      "Dùng radar K8-60 dẫn bắn tự động chính xác tuyệt đối",
      "Bắn trực diện khi B-52 bổ nhào ném bom",
    ],
    correct: 1,
    explain:
