export const puzzleQuestions = {
  ...
  "1-1": {
    ...
    options: [
      ...
      "Radar Fan Song",
      "Radar P-35",
      "Radar K8-60 của pháo phòng không",
    ],
    correct: 3,
    explain:
  ...
  "1-2": {
    ...
    options: [
      "Thực hiện cú bay nhào lộn để né tránh lưới lửa tiêm kích F-4",
      "Lao thẳng máy bay mình vào đối phương khi vũ khí không đủ tiêu diệt mục tiêu",
      "Sử dụng tên lửa tầm nhiệt để khóa mục tiêu từ xa",
      "Tắt radar để bí mật tiếp cận mục tiêu trong đêm",
    ],
    correct: 1,
    explain:
  ...
  "1-3": {
    ...
    options: [
      "Tăng công suất radar để át nhiễu",
      "Phát sóng thăm dò yếu, dụ địch gây nhiễu mạnh để lộ tâm nhiễu, rồi bắn vào đó",
      "Dùng MiG-21 làm mồi nhử B-52 bật nhiễu",
      "Chỉ dùng tên lửa tự dẫn hồng ngoại thay radar",
    ],
    correct: 1,
    explain:
  ...
  // ===== Board 2 – completely replaced =====
  "2-0": {
    q: "Chiến thuật chính của MiG-17 khi đối đầu F-4 Phantom siêu thanh là gì?",
    options: [
      "Bay cao, phóng tên lửa tầm xa trước",
      "Sử dụng radar mạnh để gây nhiễu tên lửa đối phương",
      "Phối hợp với B-52 làm mồi nhử",
      "Bay cực thấp, áp sát bất ngờ và ép đối phương vào cận chiến bằng pháo",
    ],
    correct: 3,
    explain:
  ...
  "2-3": {
    q: "Trong trận chiến ngày 7/10/1965, Nguyễn Văn Bảy đã làm gì khi máy bay bị hư hỏng nặng và được lệnh nhảy dù?",
    options: [
      "Lập tức nhảy dù để bảo toàn tính mạng.",
      "Bay sang sân bay nước bạn để hạ cánh.",
      "Kiên quyết giữ máy bay và hạ cánh an toàn.",
      "Cho máy bay rơi xuống khu vực không có dân.",
    ],
    correct: 2,
    explain:
  ...
  "4-1": {
    q: 'F-111 đã rơi vào "chiếc bẫy" nào của lực lượng phòng không Việt Nam?',
    options: [
      "Bị tiêm kích MiG phục kích trên không.",
      "Bị radar phát hiện từ rất xa.",
      "Bay vào “túi lửa” được bố trí sẵn trên hành lang bay quen thuộc.",
      "Hết nhiên liệu khi đang làm nhiệm vụ.",
    ],
    correct: 2,
    explain:
      "F-111 bay vào “túi lửa” được bố trí sẵn trên hành lang bay quen thuộc mà chúng thường sử dụng.",
    link: "#/kham-pha/ky-uc/doc-chieu-phuc-kich-f111",
  },
  "4-2": {
  ...
  "4-3": {
    q: "Điều gì được ví như “đôi cánh thứ hai” giúp MiG-21 đánh chặn B-52 hiệu quả?",
    options: [
      "Hệ thống tên lửa SAM-2 bảo vệ phía sau.",
      "Các máy bay MiG-17 bay yểm trợ.",
      "Hệ thống radar cảnh giới và dẫn đường từ mặt đất.",
      "Khả năng tự tìm kiếm mục tiêu bằng radar trên máy bay.",
    ],
    correct: 2,
    explain:
      "Hệ thống radar cảnh giới và dẫn đường từ mặt đất được ví như “đôi cánh thứ hai” giúp MiG-21 đánh chặn B-52 hiệu quả.",
...
export const finalQuestions = {
  1: {
    q: "Các mảnh ghép đã được khám phá, bạn hãy cho biết đây là khí tài nào?",
    options: [
      "Tên lửa SAM-2",
      "Tên lửa S-125-VT",
      "Tên lửa R-73",
  ...
  2: {
    ...
    options: [
      "Pháo cao xạ Flak 88mm",
      "Pháo cao xạ KS-19 100mm",
      "Pháo cao xạ 37mm",
      "Pháo cao xạ ZU-23-2",
    ],
    correct: 2,
    explain:
      "Đây là pháo cao xạ 37mm - loại pháo đã góp phần làm nên chiến thắng Điện Biên Phủ và được công nhận là Bảo vật Quốc gia.",
    link: "/kham-pha/hien-vat?exhibit=phao37mm",
  },
  3: {
    q: "Các mảnh ghép đã được khám phá, bạn hãy đoán xem đây là khí tài nào?",
    options: [
  ...
  4: {
    ...
    options: [
      "Radar Tamara",
      "Đài radar RV-02",
      "Radar cảnh giới bờ biển tầm trung VRS-CSX",
      "Radar P-35",
    ],
    correct: 3,
    explain:
